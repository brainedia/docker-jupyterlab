...
CMD cd ~/jupyterlab && export JUPYTER_DATA_DIR=/var/lib/docker/volumes/jupyter_data && jupyter lab --ip 0.0.0.0 --port 8888 --NotebookApp.notebook_dir=$JUPYTER_DATA_DIR --allow-root --no-browser
